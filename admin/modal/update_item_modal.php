			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="assetTag-update">Asset Tag:</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="assetTag-update" placeholder="Enter Asset Tag" autofocus>
					    </div>
					  </div>
